...
<!--
  ...
  📦 Versión del generador: v{{version}}
-->

# GLASTOR® — Ingeniería de Sistemas y Backend

**Ingeniero de Software en Rust & Python · Arquitecto de API · Automatización y DevOps**
...
[![codecov](https://codecov.io/gh/glastor-dev/glastor-dev/branch/master/graph/badge.svg)](https://codecov.io/gh/glastor-dev/glastor-dev)
...
Desarrollo **sistemas de ultra-alto rendimiento**, **APIs REST** y **herramientas CLI** utilizando **Rust** y **Python** para entornos de misión crítica. Más de **15 años** creando soluciones escalables y seguras desde el diseño de memoria para empresas tecnológicas.

**Fundador de GLASTOR®** — Especializado en arquitectura de sistemas, DevOps y soluciones técnicas de bajo nivel que reducen los costos de infraestructura hasta un 40%.

> _"Andres entregó una solución de API que maneja 5,000 req/s con latencia p99 < 50ms. Su trabajo redujo nuestros costos de infraestructura significativamente."_  
> — **Dan Khasis
> Chief Executive Officer and Founde, Route4Me**

### 💼 Especialidades técnicas

- ✅ **Backend Rust & Python** — APIs con Axum, Actix-Web y FastAPI, optimizadas para extrema concurrencia.
- ✅ **Tooling & CLI** — Herramientas de terminal ultrarrápidas y binarios portables (Zero-cost abstractions).
...
- 🚀 **CLI migration a Rust** — Sistema ultrarrápido y seguro de generación de docs (ETA: Feb 2026)
...
- **Code review** y auditoría de seguridad en proyectos Rust/Python
...
<p align="center">
  ...
  <img src="https://skillicons.dev/icons?i=rust,python,bash,linux,c" alt="Backend" /><br><br>
  <strong>Frameworks & APIs:</strong><br>
  <img src="https://skillicons.dev/icons?i=fastapi,django,vue,vite,nextjs,svelte" alt="Frameworks" /><br><br>
...
![GitHub Stats](./images/github_stats.svg)

**🔥 Contribuciones en {{current_year}}:** 847 commits • 23 repos • 156 PRs merged
...
```bash
# Vía Cargo (compilación desde origen)
cargo install --git https://github.com/glastor-dev/glastor-dev.git
...
© 2010-{{current_year}} GLASTOR-DEV — Todos los derechos reservados.

**{{current_year}} GLASTOR®** marca registrada en Argentina (INPI)  
...
<sub>🤖 README generado automáticamente • Versión {{version}} • Última actualización: {{current_date}}</sub>  
