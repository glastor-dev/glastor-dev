...
<p align="center">
  <img src="https://github-readme-streak-stats.herokuapp.com/?user=glastor-dev&theme=radical&hide_border=true&locale=es" alt="Racha de GitHub" />
</p>
...
**Web Technologies**
`HTML5` • `CSS3` • `JavaScript` • `TypeScript` • `React` • `REST APIs` • `GraphQL`

**Cybersecurity**
`OWASP Top 10` • `Pentesting` • `Nmap` • `Wireshark` • `Burp Suite` • `Kali Linux` • `Threat Modeling`
...
- **🐍 Mejores prácticas en Python 2025** - [YouTube](https://www.youtube.com/@glastor-es) *(2025)*
- **🚀 Construyendo APIs escalables con FastAPI** - [YouTube](https://www.youtube.com/@glastor-es) *(2025)*
